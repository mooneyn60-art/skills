...
| Wash-sale flags / disallowed-loss tracking | **No** — nothing in the schema checks whether a loss on `symbol` X falls within 30 days of a prior or subsequent entry in the same or a substantially identical instrument on X |
